...
> **🏆 最终选定：kimi 版**（[`kimi/`](kimi/) 子目录）。
> 综合「安全性（0 违规、0 崩溃）+ 最小修改精度（QP 模式平均 TCP 偏离 5.0mm、停滞步数 0）+ 完整度（72 项测试、8 场景、README 9 问）」三项，kimi 是三个实现中唯一无短板且算法精度最高的。
> **面试演示与最终提交均以此版为准**；codex / deepseek 为对比备选，详见 [COMPARISON.md](COMPARISON.md)。
